...
const recentNews = [
  {
    ...
    excerpt:
      "Cuộc thi lập trình lớn nhất trong năm của câu lạc bộ chính thức được khởi động...",
    time: "2 giờ trước",
    category: "Cuộc thi",
  },
  {
    ...
    excerpt:
      "Tham gia workshop miễn phí về AI cơ bản dành cho các thành viên mới...",
    time: "5 giờ trước",
    category: "Workshop",
  },
  {
    ...
    excerpt:
      "Câu lạc bộ thông báo lịch nghỉ Tết và các hoạt động trong thời gian này...",
    time: "1 ngày trước",
    category: "Thông báo",
  },
];
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-600">
          Chào mừng bạn quay trở lại với SFIT Club. Hãy xem những gì mới trong
          hôm nay.
        </p>
      </div>
        ...
        <div className="lg:col-span-2">
          <div className="card">
            <div className="flex items-center justify-between mb-10">
              ...
              <Link
                href="/news"
                className="text-[#267452] hover:text-[#1f5e42] text-sm font-medium"
              >
                Xem tất cả →
              </Link>
            </div>
            <div className="space-y-4">
              {recentNews.map((news) => (
                <div
                  key={news.id}
                  className="border-l-4 border-[#267452] pl-4 hover:bg-gray-50 p-3 rounded-r-lg transition-colors duration-200"
                >
